...
import mx.uv.sistemagestionpizzeria.exception.EntidadDuplicadaException;
...
public class ProductoService {
    ...
    public void editar(ProductoDTO producto) throws NegocioException, SQLException {
        ...
        try (java.sql.Connection con = mx.uv.sistemagestionpizzeria.config.ConexionBD.getConexion()) {
            try {
